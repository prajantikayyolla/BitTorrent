...
public class StartRemotePeers {
	private static final String scriptPrefix = "cd /cise/homes/prajan/CNProject/src/com/company;java -cp /cise/homes/prajan/CNProject/src com.company.peerProcess ";
	
//    private static final String scriptPrefix = "cd CNProject/src/com/company;javac -cp ..\\..\\..\\jsch-0.1.54.jar;.  *.java; java -cp \\cise\\homes\\prajan\\CNProject\\src\\com\\company peerProcess ";
    ...
    public static void main(String[] args) {
        ...
        String ciseUser = "prajan"; // change with your CISE username
 ...
 */
		...
		peerList.add(new PeerInfo("1007", "lin114-06.cise.ufl.edu"));
        peerList.add(new PeerInfo("1008", "lin114-07.cise.ufl.edu"));
        peerList.add(new PeerInfo("1009", "lin114-08.cise.ufl.edu"));
        ...
        for (PeerInfo remotePeer : peerList) {
            try {
                 ...
                 */
                jsch.addIdentity("C:\\Users\\praja\\.ssh\\private", "");
